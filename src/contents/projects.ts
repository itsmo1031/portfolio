...
const habitz: Item = {
  ...
  skills: [
    ...
    },
    {
      keyword: 'Next.js 14',
      description:
        'Next.js가 제공하는 Routing, Font Optimization, Image Optimization을 이용하고, 방대한 React 라이브러리를 사용할 수 있다는 이점이 있어 사용하였습니다.',
    },
    {
      keyword: 'Storybook',
      description:
        '컴포넌트를 시각화/문서화하고, 컴포넌트 단위로 개발하여 재사용이 용이한 컴포넌트를 제작하고자 사용하였습니다.',
    },
    {
      keyword: 'Zustand',
      description:
        '로그인 데이터와 같은 사용자 상태 정보를 클라이언트에서 관리하기 위해 사용하였습니다.',
    },
    {
      keyword: 'Tanstack Query',
      description:
        '서버 데이터들을 클라이언트 데이터와 분리하여 관리하기 위해 사용하였습니다.',
    },
    {
      keyword: 'PandaCSS',
      description:
        'Type-safe한 스타일링이 가능하고, 런타임 오버헤드가 없어 퍼포먼스가 뛰어나 채택하였습니다.',
    },
    {
      keyword: 'React Hook Form',
      description:
        '회원가입, 결제 등 form 검증이 필요한 컴포넌트에 사용하여 잘못된 데이터가 전송되지 않도록 하기 위해 사용하였습니다.',
    },
  ],
  images: [
    {
...
const lyricit: Item = {
  ...
  skills: [
    ...
    },
    {
      keyword: 'Zustand',
      description:
        '닉네임, 아바타와 같은 사용자 상태 정보를 클라이언트에서 관리하기 위해 사용하였습니다.',
    },
    {
      keyword: 'Tanstack Query',
      description:
        'REST API로 호출한 초기 데이터 및 STOMP 프로토콜로 추가되는 서버 데이터들을 클라이언트 데이터와 분리하여 관리하기 위해 사용하였습니다.',
    },
    {
      keyword: 'TailwindCSS',
      description:
        'className만으로 손쉽게 CSS를 제어할 수 있어 사용하였습니다. 동적으로 className을 할당하고 중복을 최소화하기 위해 clsx와 tailwind-merge를 활용하였고, class-variance-authority를 활용해 컴포넌트에 variant를 주어 한 컴포넌트에 대해 다양한 variant를 제공하여 재사용성을 높였습니다.',
    },
    {
      keyword: 'Framer Motion',
      description:
        '인터랙티브한 UI를 제공하여 실시간 게임의 특징을 살림으로써 사용자 경험을 더욱 가치있게 만들고자 사용하였습니다.',
    },
    {
      keyword: 'React Hook Form',
      description:
        '회원 로그인, 방 생성 등 form 검증이 필요한 컴포넌트에 사용하여 잘못된 데이터가 전송되지 않도록 하기 위해 사용하였습니다.',
    },
  ],
  images: [
    {
      src: '/projects/lyricit/lyricit-landing-page.mp4',
      alt: '랜딩 페이지',
      type: 'video',
    },
    {
    ...
    {
      src: '/projects/lyricit/lyricit-waiting.mp4',
      alt: '대기방 화면',
      type: 'video',
    },
    {
      src: '/projects/lyricit/lyricit-correct.mp4',
      alt: '게임 중 정답을 맞췄을 때 화면',
      type: 'video',
    },
    {
      src: '/projects/lyricit/lyricit-wrong.mp4',
...
const oomool: Item = {
  ...
  skills: [
    ...
    },
    {
      keyword: 'Nuxt.js',
      description:
        'Vue 환경에 익숙한 팀원들이 다수였고, 웹 프레임워크가 가져다 주는 이점에 대해 학습하고자 사용하였습니다.',
    },
    {
      keyword: 'Spring',
      description:
        'REST API를 구축하기 편리하고 Spring Data, Security 등 웹 개발에서 필수적인 기능을 구현하기 쉽게 만들어주는 프레임워크를 제공하고 있어 사용하였습니다.',
    },
    {
      keyword: 'MariaDB',
      description:
        '관계성이 필요한 데이터들을 쉽게 관리할 수 있어 선택하였습니다.',
    },
    {
      keyword: 'Redis',
      description:
        '영속성이 필요하지 않은 임시 데이터(대기방)를 관리하고 캐시를 사용하여 데이터를 보다 빠르게 제공하기 위해 선택하였습니다.',
    },
    {
      keyword: 'Progressive Web App',
      description:
        '웹 페이지를 이용하면서도 모바일 앱을 이용할 때와 동일한 사용자 경험을 제공하기 위해 선택하였습니다.',
    },
    {
      keyword: 'Firebase Cloud Messaging',
      description:
        'PWA 앱을 설치한 기기에 푸시 알림을 손쉽게 제공할 수 있어 선택하였습니다.',
    },
  ],
  images: [
    {
  ...
  skills: [
    {
      keyword: 'Javascript',
      description:
        'Web Speech API를 활용하여 음성 인식 기능을 사용하고, 웹 페이지를 동적으로 제어해 게임 화면을 그리기 위해 사용하였습니다. ES6 문법을 이용하였고, Strict 모드를 사용하여 에러를 예측 가능하게 함으로써 코드의 안전성을 높이고자 하였습니다.',
    },
  ],
  images: [
    {
...
const projects: Payload = {
  disabled: false,
  list: [habitz, lyricit, oomool, speechGame],
};
